    ...
    public static void main(String[] args) {
        ...
        String[][] choices = {
                ...
                { "0", "1", "Go into the wilderness in search of an adventure",
                        "You have arrived in the wilderness. You encounter a monser" },
        ...
        while (!gameover) {
            ...
            viableChoices.clear();
            // manual skip changes and new mechanics
            if (currentChoice == 2) {
                if (pGold > 100) {
                    pGold -= 100;
            ...
            if (currentChoice == 7) {
                ...
                int pDamage = r.nextInt(1, pAttack);
                int mDamage = r.nextInt(1, mAttack);
                mLife -= pDamage;
                if (mLife > 0) {
                    pLife -= mDamage;
                }
                if (pLife > 0) {
                    if (mLife > 0) {
                        System.out.printf("%s %d %s %d %s\n", "You hit the monster with", pDamage,
                                "Damage. It still has",
                                mLife, "HP left.");
                        System.out.printf("%s %d %s %d %s\n", "The monster hit you with", mDamage,
            ...
            if (currentChoice == 8) {
                int mDamage = r.nextInt(0, mAttack);
                pLife -= mDamage;
                System.out.printf("%s %d %s\n",
